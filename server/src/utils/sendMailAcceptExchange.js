...
const SendMailAcceptExchange = async (email, orderCode) => {
    try {
        ...
        const info = await transport.sendMail({
            ...
            text: `Yêu cầu đổi hàng cho đơn ${orderCode} của bạn đã được chấp nhận. Vui lòng gửi hàng về địa chỉ: 235 Hoàng Quốc Việt, BTL, Hà Nội.`,
            html: `
            <!DOCTYPE html>
            <html lang="vi">
            <head>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="address-box">
                            235 Hoàng Quốc Việt, BTL, Hà Nội
                        </div>
                        <div class="message">
